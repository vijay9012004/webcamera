...
if st.session_state.page=="welcome":
    ...
    rules=["🌤️ Ensure you are well-rested before driving",
           "🕶️ Take breaks if you feel sleepy","🚰 Stay hydrated",
           "📵 Avoid distractions","❤️ Safety is more important than speed"]
